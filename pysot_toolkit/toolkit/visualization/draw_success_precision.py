...
def draw_success_precision(success_ret, name, videos, attr, precision_ret=None,
    ...
    import os
    save_root = os.path.join('plots', name)
    ...
    save_path = os.path.join(save_root, f'{name}_{attr}_success.png')
    ...
    if precision_ret:
        ...
        save_path = os.path.join(save_root, f'{name}_{attr}_precision.png')
        plt.savefig(save_path, dpi=300, bbox_inches='tight')
        plt.close()
    ...
    if norm_precision_ret:
        ...
        save_path = os.path.join(save_root, f'{name}_{attr}_norm_precision.png')
        plt.savefig(save_path, dpi=300, bbox_inches='tight')
        plt.close()
