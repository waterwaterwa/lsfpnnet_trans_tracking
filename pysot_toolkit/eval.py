# python eval.py --tracker_path results --dataset OTB100 --tracker_prefix sot --dataset_root /path/to/otb --vis
# python eval.py --tracker_path results --dataset UAV123 --tracker_prefix sot --dataset_root /path/to/uav123/UAV123/data_seq --vis
# python eval.py --tracker_path results --dataset NFS240 --tracker_prefix sot --dataset_root /path/to/Nfs --vis
# python eval.py --tracker_path results --dataset VID --tracker_prefix sot --dataset_root /path/to/vid --vis
...
parser.add_argument(
    ...
    type=str,
    default=None,
    help='root directory of evaluation datasets'
)
...
#     root = os.path.join(root, args.dataset)
    ...
    if args.dataset_root is not None:
        ...
        root = os.path.realpath(os.path.join(
            os.path.dirname(__file__), 'testing_dataset', args.dataset
        ))
