#  python test_GOT10k.py --dataset GOT-10k --name sot
#  python test_GOT10k.py --dataset GOT-10k-test --name sot
...
def main():
    ...
    dataset_root = ''  # Set your GOT-10k test dataset path here
    net_path = 'checkpoint.pth.tar' #Absolute path of the model

    # create model
    net = NetWithBackbone(net_path=net_path, use_gpu=True)
    tracker = Tracker(name='sot', net=net, window_penalty=0.49, exemplar_size=128, instance_size=256)
