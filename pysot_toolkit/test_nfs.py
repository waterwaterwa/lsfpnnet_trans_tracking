...
import os
import sys
#python -u test_nfs.py --dataset NFS240 --name 'sot'
...
def main():
    ...
    dataset_root = ''  # Set your NFS dataset path here
    ...
    # 修改输入图像的尺寸
    tracker = Tracker(name='NFS240', net=net, window_penalty=0.49, exemplar_size=128, instance_size=288)
